...
import com.yejh.utils.LogUtilsOriginal;
    ...
    public static Calculator getProxy(final Calculator calculator) {
        ...
        InvocationHandler h = new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                Object res = null;
                try {
                    LogUtilsOriginal.logStart(method, args);
                    //proxy：代理对象，给jdk使用
                    res = method.invoke(calculator, args);
                    //返回值要返回，外界才能拿到
                    LogUtilsOriginal.logReturn(method, res);
                } catch (Exception e) {
                    LogUtilsOriginal.logException(method, e);
                } finally {
                    LogUtilsOriginal.logEnd(method);
                }
